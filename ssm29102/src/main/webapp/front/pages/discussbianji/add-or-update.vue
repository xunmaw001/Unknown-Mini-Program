	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussbianji`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																												...
																																																																												if(this.ruleForm.id){
					await this.$api.update(`discussbianji`, this.ruleForm);
				}else{
					await this.$api.add(`discussbianji`, this.ruleForm);
				}
				uni.setStorageSync('discussbianjiCleanType',true);
