<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发送人账号" prop="fasongrenzhanghao">
          <el-input v-model="ruleForm.fasongrenzhanghao" 
              placeholder="发送人账号" clearable  :readonly="ro.fasongrenzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发送人账号" prop="fasongrenzhanghao">
              <el-input v-model="ruleForm.fasongrenzhanghao" 
                placeholder="发送人账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发送人姓名" prop="fasongrenxingming">
          <el-input v-model="ruleForm.fasongrenxingming" 
              placeholder="发送人姓名" clearable  :readonly="ro.fasongrenxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发送人姓名" prop="fasongrenxingming">
              <el-input v-model="ruleForm.fasongrenxingming" 
                placeholder="发送人姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	fengmian : false,
	tixingshijian : false,
	fasongrenzhanghao : false,
	fasongrenxingming : false,
	zhanghao : false,
	xingming : false,
	userid : false,
      },
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tixingshijian = true;
          ...
          if(o=='fasongrenzhanghao'){
            this.ruleForm.fasongrenzhanghao = obj[o];
	    this.ro.fasongrenzhanghao = true;
            continue;
          }
          if(o=='fasongrenxingming'){
            this.ruleForm.fasongrenxingming = obj[o];
	    this.ro.fasongrenxingming = true;
            continue;
          }
          if(o=='zhanghao'){
	...
	this.ruleForm.tixingneirong = this.ruleForm.tixingneirong.replace(reg,'../../../ssm29102/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
